...
const RegisterCall = () => {
  ...
  useEffect(() => {
    const isFormComplete =
      !!selectedSector && !!selectedCategory && description.trim().length >= MIN_DESC_LENGTH;
  ...
  return (
    <View style={styles.formContainer}>
      ...
      <Text style={styles.headerSubtitle}>Preencha os detalhes para abrir um chamado.</Text>
      ...
      <View style={styles.inputGroup}>
        ...
        />
        <Text style={styles.helperText}>Mínimo de {MIN_DESC_LENGTH} caracteres.</Text>
      </View>
      ...
      {showSuccessMessage && (
        <View style={styles.successContainer}>
          ...
          <Text style={styles.successMessage}>Solicitação enviada com sucesso!</Text>
        </View>
      )}
